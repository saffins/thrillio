...
public class DataStore {
	...
	private static void loadBooks() {
		...
		bookmarks[2][1] = BookmarkManager.getInstance().createBook(4000,"Walden",1854,"Wilder Publications",new String[]{"Henry David","Thoreau"},	"Philosophy",4.3)	;
		bookmarks[2][2] = BookmarkManager.getInstance().createBook(4000,"Walden",1854,"Wilder Publications",new String[]{"Henry David","Thoreau"},	"Philosophy",4.3)	;
		bookmarks[2][3] = BookmarkManager.getInstance().createBook(4000,"Walden",1854,"Wilder Publications",new String[]{"Henry David","Thoreau"},	"Philosophy",4.3)	;
		bookmarks[2][4] = BookmarkManager.getInstance().createBook(4000,"Walden",1854,"Wilder Publications",new String[]{"Henry David","Thoreau"},	"Philosophy",4.3)	;
